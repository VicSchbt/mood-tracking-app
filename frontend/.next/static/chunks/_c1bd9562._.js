...
const useAuthStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set)=>({
        ...
        signup: async (email, password)=>{
            const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signup"])(email, password);
            if (user) {
                set({
                    user
                });
...
const LoginPage = ()=>{
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        const success = mode === 'signin' ? await login(email, password) : await signup(email, password);
        if (success) {
            router.push('/');
        } else {
...
_s(LoginPage, "QHPYnQBkbNzE1SdEjSXslOXWhqM=", false, function() {
    return [
...
//# sourceMappingURL=_c1bd9562._.js.map